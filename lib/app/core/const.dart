...
class ThemeColors {
  ...
  static const Color primaryMedium = Color(0xFF5f77cd);
  static const Color primaryLight = Color(0xFF8799DA);
  static const Color primaryLightest = Color(0xFFA8BFFF);
  ...
  static const Color successDark = Color(0xFF288267);
  static const Color successMedium = Color(0xFF33A885);
  static const Color successLight = Color(0xFF3ecea3);
  ...
  static const Color errorDarkest = Color(0xFFE30000);
  static const Color errorMedium = Color(0xFFFFADB9);
  static const Color errorLight = Color(0xFFF9C2C3);
  static const Color errorLightest = Color(0xFFFFF2F4);
}
